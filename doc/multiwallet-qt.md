...
In order to support loading of multiple wallets in kingston-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kingston.cpp.
...
Changes to kingston.cpp
----------------------
kingston.cpp is the entry point into kingston-qt, and as such, will require some minor modifications to provide hooks for
