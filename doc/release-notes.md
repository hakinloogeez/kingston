Kingston Core version 2.2.1 is now available from:

  <https://github.com/kingston-project/kingston/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/kingston-project/kingston/issues>

Compatibility
==============

Kingston Core is extensively tested on multiple operating systems using
...
Kingston Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Kingston was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/kingston-project-translations/).
