...
/** Utility functions used by the Kingston Qt UI.
 */
namespace GUIUtil
{
...
// Render Kingston addresses in monospace font
...
// Parse "kingston:" URI into recipient object, return true on successful parsing
