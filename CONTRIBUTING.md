Contributing to Kingston Core
============================

The Kingston Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kingston Core project, and is not to be
confused with overall Kingston Network Protocol consensus changes.

Whether a pull request is merged into Kingston Core rests with the project merge
...
Patches that change Kingston consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kingston consensus, it must have been
...
The project leader is the release manager for each Kingston Core release.
