...
RESOURCES += src/qt/kingston.qrc src/qt/kingston_locale.qrc

TRANSLATIONS += src/qt/locale/kingston_bg.ts \
                src/qt/locale/kingston_de.ts \
                src/qt/locale/kingston_en.ts \
                src/qt/locale/kingston_es.ts \
                src/qt/locale/kingston_fi.ts \
                src/qt/locale/kingston_fr.ts \
                src/qt/locale/kingston_it.ts \
                src/qt/locale/kingston_ja.ts \
                src/qt/locale/kingston_pl.ts \
                src/qt/locale/kingston_pt.ts \
                src/qt/locale/kingston_ru.ts \
                src/qt/locale/kingston_sk.ts \
                src/qt/locale/kingston_sv.ts \
                src/qt/locale/kingston_vi.ts \
                src/qt/locale/kingston_zh_CN.ts \
                src/qt/locale/kingston_zh_TW.ts
