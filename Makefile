...
pkgdatadir = $(datadir)/kingston
pkgincludedir = $(includedir)/kingston
pkglibdir = $(libdir)/kingston
pkglibexecdir = $(libexecdir)/kingston
...
CONFIG_HEADER = $(top_builddir)/src/config/kingston-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/kingston-config.h.in \
...
ACLOCAL = ${SHELL} /home/ubuntu/Desktop/king/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ubuntu/Desktop/king/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/Desktop/king/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/Desktop/king/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/ubuntu/Desktop/king/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = kingston
PACKAGE_BUGREPORT = www.kingston.com
PACKAGE_NAME = Kingston Core
PACKAGE_STRING = Kingston Core 1.0.0
PACKAGE_TARNAME = kingston
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/ubuntu/Desktop/king
abs_srcdir = /home/ubuntu/Desktop/king
abs_top_builddir = /home/ubuntu/Desktop/king
abs_top_srcdir = /home/ubuntu/Desktop/king
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ubuntu/Desktop/king/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/kingstond$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/kingston-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/kingston-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = Kingston-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_kingston_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_kingston_coverage.info test_kingston.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Kingston-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/kingston-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/kingston-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/kingston-config.h
$(top_srcdir)/src/config/kingston-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/kingston-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Kingston-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Kingston-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Kingston-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_kingston.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_kingston -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_kingston_filtered.info: test_kingston.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_kingston_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_kingston_coverage.info: baseline_filtered_combined.info test_kingston_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kingston_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_kingston_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kingston_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_kingston.coverage/.dirstamp:  test_kingston_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_kingston.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_kingston.coverage/ total.coverage/ $(OSX_APP)
